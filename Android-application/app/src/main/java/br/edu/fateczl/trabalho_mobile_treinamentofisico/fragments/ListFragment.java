...
public class ListFragment extends Fragment {
    ...
    private void search() {
        ...
        if (rbList01.isChecked()) {
            ...
            url = "http://192.168.72.240:8080/api/trainings"; // Substitua pelo seu endpoint real
        } else if (rbList02.isChecked()) {
            // URL para buscar treinos do tipo "home"
            url = "http://192.168.72.240:8080/api/trainings/type/Home"; // Substitua pelo seu endpoint real
        } else if (rbList03.isChecked()) {
            // URL para buscar treinos do tipo "gym"
            url = "http://192.168.72.240:8080/api/trainings/type/Gym"; // Substitua pelo seu endpoint real
        } else {
